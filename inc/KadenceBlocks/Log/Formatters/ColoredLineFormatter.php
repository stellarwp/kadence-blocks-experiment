...
namespace KadenceWP\KadenceBlocks\Log\Formatters;
...
class ColoredLineFormatter extends LineFormatter {
	...
	public function format( array $record ): string {
		...
		$formatted = str_replace( '%color_start%', $this->colorScheme[ \KadenceWP\FrontendWizard\Log\Log_Level::toPsrLogLevel( $record['level'] ) ], $formatted );
