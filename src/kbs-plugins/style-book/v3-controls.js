 ...
 * Import Settings
 */
import KadenceEditorWidth from '../../plugins/editor-width';
import KadenceSetting from '../../plugins/settings';
import KadenceColors from '../../plugins/block-defaults/color-palette-defaults';

/*
 * Components
 */
import KadenceFontFamily from '../../plugins/block-defaults/typography-defaults';
import KadenceVisibilitySettings from '../../plugins/block-visibility-settings';
import ExportDefaults from '../../plugins/block-defaults/export-defaults';
import ImportDefaults from '../../plugins/block-defaults/import-defaults';
import ResetDefaults from '../../plugins/block-defaults/reset-defaults';
import DefaultEditorBlock from '../../plugins/default-editor-block';

/**
 * V3 Controls Component
 * Contains all the v3 Kadence Blocks controls
 */
function V3Controls() {
	...
	return (
		<Fragment>
			<PanelBody title={__('Color Palette', 'kadence-blocks')} initialOpen={false}>
				<KadenceColors />
			</PanelBody>
