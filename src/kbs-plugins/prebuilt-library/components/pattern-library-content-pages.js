...
const PatternLibraryContentPagesList = ({
	pattern,
	patternHTML,
	onClick,
	showTooltip,
...
const PatternLibraryContentPages = ({
	patterns,
	patternsHTML,
	category,
	style,
	...
	return <PatternLibraryContentPagesList patterns={filteredBlockPatterns} patternsHTML={patternsHTML} />;
};

export default PatternLibraryContentPages;
