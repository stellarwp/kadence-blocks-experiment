				...
				if (variantValue) {
					...
					if (variantData?.attributes) {
						Object.entries(variantData.attributes).forEach(([componentName, componentValue]) => {
							// Check if this component has a preset defined in the variant
							if (componentValue?.preset) {
								// Only set the preset if the component doesn't already have one
								if (!modifiedAttributes[componentName]?.preset) {
