...
export const BORDER_RADIUS_SIZES_MAP = [
	...
	{
		value: 'sm',
		output: 'var(--global-kb-borderradius-sm, clamp(5px, 3.4321px + 0.3484vw, 7px))',
	...
	{
		value: 'md',
		output: 'var(--global-kb-borderradius-md, clamp(15px, 10.2962px + 1.0453vw, 21px))',
	...
	{
		value: 'lg',
		output: 'var(--global-kb-borderradius-lg, clamp(30px, 20.5923px + 2.0906vw, 42px))',
	...
	{
		value: 'xl',
		output: 'var(--global-kb-borderradius-xl, clamp(60px, 41.1847px + 4.1812vw, 84px))',
	...
	{
		value: 'full',
		output: 'var(--global-kb-borderradius-full, 100%)',
