...
function TransformSkew(props) {
	...
	const handleMouseMove = useCallback(
		(e) => {
			if (!isDragging || !dragStartRef.current || !dragAxis) {
				return;
			}
	...
	return (
		<div className="kadence-transform-skew-content">
			<div className="kadence-transform-title-wrapper">
				<span className="kadence-transform-skew-title">{__('Transform Skew', 'kadence-blocks')}</span>
				<Button
			...
			<div className="kadence-transform-skew-visual" ref={containerRef}>
				...
				<div
					className={`kadence-transform-skew-wrapper${isInherited ? ' kbs-inherited' : ''}`}
					style={transformStyle}
				>
					<div className="kadence-transform-skew-box" ref={boxRef} />
				...
				<div className="kadence-transform-skew-input-wrapper">
					...
					<div className="kadence-transform-skew-link-wrapper">
						<Button
							...
							label={
								isLinking ? __('Unlink values', 'kadence-blocks') : __('Link values', 'kadence-blocks')
							}
							aria-label={
								isLinking
									? __('Unlink X and Y values', 'kadence-blocks')
									: __('Link X and Y values', 'kadence-blocks')
							}
						/>
					</div>
