	...
	return (
		<div className="kadence-transform-origin-content">
			<div className="kadence-transform-title-wrapper">
				<span className="kadence-transform-origin-title">{__('Transform Origin', 'kadence-blocks')}</span>
				<Button
			...
			<div className="kadence-transform-origin-visual">
				<div className="kadence-transform-origin-container">
					<div
						className={`kadence-transform-origin-reference-box${isInherited ? ' kbs-inherited' : ''}`}
						ref={gridRef}
					>
